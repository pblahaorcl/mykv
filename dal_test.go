...
// createTestDAL creates a test data access layer and returns a cleanup function.
...
// TestCreateAndGetNode tests creating and retrieving a node.
...
// TestDeleteNodeAndReusePage tests deleting a node and reusing its page.
...
// TestCreateDalWithNewFile tests creating a data access layer with a new file.
...
// TestCreateDalWithExistingFile tests creating a data access layer with an existing file.
